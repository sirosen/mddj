...
def test_can_discover_unambiguous_project_dir(chdir, tmp_path, indicator_file):
...
def test_discovery_skips_setup_py_dir_with_init_py(chdir, tmp_path):
...
def test_discovery_selects_setup_py_at_repo_root_as_final_guess(chdir, tmp_path):
    # "repo root"
